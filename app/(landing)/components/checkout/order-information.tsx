  ...
  return (
    <CardWithHeader title="Order Information">
        <div className="p-5">
           ...
           <div className="input-group">
            <label htmlFor="customerAdddress">Shipping Address</label>
            <textarea placeholder="Type your shipping address" id="customerAddress" name="customerAddress" value={formData.customerAddress} onChange={handleInputChange}
            rows={7} />
           </div>
        </div>
    </CardWithHeader>
