...
const ProductModal = ({isOpen, onClose, onSuccess, product}: TProductModalProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error(
                isEditMode ? "Failed to update product" : "Failed to created product", error,
            );
            toast.error(
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? "Edit Product" : "Add New Product"}>
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <Button className="ml-auto mt-3 rounded-lg" onClick={handleSubmit} type="submit" disabled={isSubmitting}>
                    {
