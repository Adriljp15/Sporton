                ...
                <div>
                    ...
                    <div className="bg-gray-100 rounded-md flex flex-col gap-2.5 p-4 text-xs mb-5">
                        ...
                        <div className="flex justify-between font-medium">
                            ...
                            <div className="text-right">12123</div>
                        </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-2 flex items-center gap-2">
                        <div className="bg-gray-100 rounded aspect-square w-8 h-8">
                            <Image src="/images/products/produk (1).png" width={30} height={30} alt="product image" />
                        </div>
                    ...
                    <div className="flex justify-between text-xs mt-6">
                        ...
                        <div className="text-primary font-semibold">{priceFormatter(45000)}</div>
                    </div>
